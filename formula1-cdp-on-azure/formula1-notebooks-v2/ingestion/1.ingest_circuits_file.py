...
.csv(f"{raw_forder_path}/circuits.csv")
...
circuits_final_df.write.mode("overwrite").parquet(f"{processed_forlder_path}/circuits")

# COMMAND ----------

display(spark.read.parquet(f"{processed_forlder_path}/circuits"))
